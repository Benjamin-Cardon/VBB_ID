...
function RegisterPatron(register_props: props) {
  ...
  const [affiliated_modal_open, set_affiliated_modal_open] = useState(false);
  ...
  const [affiliated, setAffiliated] = useState(null as state_toggle);
    ...
    <Container maxWidth='md'>
      <Box display="flex" flexDirection="column" alignItems="center">
        ...
        >
          <Box>
            <FormControl >
              <FormLabel>Do you already have a profile with our mentorship program?</FormLabel>
              <RadioGroup
                value={affiliated}
                onChange={handle_affiliated}>
