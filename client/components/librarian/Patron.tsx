...
import { Box, IconButton, Paper, Stack, Typography, Container, Divider } from "@mui/material";
...
function Patron({ patron }: { patron: patron }) {
  ...
  return (
    <Paper>
      ...
      {expanded && <Stack direction='row' divider={<Divider orientation="vertical" flexItem />} alignContent='center' justifyContent='space-evenly'>
        <Container id='Left'>
